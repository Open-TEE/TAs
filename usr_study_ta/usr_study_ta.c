...
static TEE_Result deposit_transaction(uint32_t paramTypes, TEE_Param *params)
{
						...
						uint32_t paramTypes, TEE_Param params[4])
{
	...
	case USR_STUDY_CMD_DEPOSIT:
		ret = deposit_transaction(paramTypes, params);
		break;

	case USR_STUDY_CMD_WITHDRAW:
		break;

	case USR_STUDY_CMD_GET_BALANCE: break;
